...
public class TableFrame extends JFrame {
	...
	public List<CodeTable> getSelectedTables() {
		return tmd.getSelectedTables();
	}
	class MyTableModel extends AbstractTableModel {
		...
		public List<CodeTable> getSelectedTables() {
			List<CodeTable> tableNameList = new ArrayList<CodeTable>();
			if (null != codeTableList) {
				for (CodeTable codeTable : codeTableList) {
					if (codeTable.getSelected()) tableNameList.add(codeTable);
				}
			}
			return tableNameList;
		}
