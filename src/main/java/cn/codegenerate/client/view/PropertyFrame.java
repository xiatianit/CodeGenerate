package cn.codegenerate.client.view;
...
public class PropertyFrame extends JFrame {
	...
	public PropertyFrame(ActionListener actionListener) {
		...
		ipAddressLabel.setPreferredSize(new Dimension(100, 30));
		row1.add(ipAddressLabel);

		ipAddressText = new JTextField();
		ipAddressText.setFont(font);
		ipAddressText.setColumns(30);
		ipAddressText.setText("db2.banmabike.com");
		...
		passwordText.setText("Ebike#@!2017");
		...
		dbNameLabel.setPreferredSize(new Dimension(100, 30));
		row6.add(dbNameLabel);

		dbNameText = new JTextField();
		dbNameText.setFont(font);
		dbNameText.setColumns(30);
		dbNameText.setText("ebike");
		row6.add(dbNameText);
		...
		packagePathLabel.setPreferredSize(new Dimension(100, 30));
		row7.add(packagePathLabel);

		packagePathText = new JTextField();
		packagePathText.setFont(font);
		packagePathText.setColumns(30);
		packagePathText.setText("com.zebra.zebraerp");
		...
		userPathText.setColumns(20);
		userPathText.setText("");
		row8.add(userPathText);

		jfc = new JFileChooser();
		jfc.setCurrentDirectory(new File("D:/Generate"));
