...
public class StringUtill {
	 ...
	 * @return String
	 */
	public static final String firstCharacterLowerCase(String oldName) {
		String first = oldName.substring(0, 1).toLowerCase();
		String rest = oldName.substring(1, oldName.length());
