package cn.codegenerate.client.controller;
...
import cn.codegenerate.client.module.GenerateProcess;
import cn.codegenerate.client.module.TableModule;
import cn.codegenerate.client.utils.ValidateUtils;
import cn.codegenerate.client.view.PropertyFrame;
import cn.codegenerate.client.view.TableFrame;
...
//			CodeTable codeTable = null;
			List<CodeTable> tableList = tableFrame.getSelectedTables();
			TableModule tableModule = new TableModule();
...
//					codeTable.setTableName(tableName);
					codeColumnList = tableModule.queryCodeColumnList(generateInfo, codeTable.getTableName());
